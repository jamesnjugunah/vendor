  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 rounded-full gradient-kenya flex items-center justify-center">
              <span className="text-xl"><img src={logo} alt="" /></span>
            </div>
      ...
      <section className="py-20 px-4 animate-fade-in">
        ...
        <span className="block bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary leading-tight">
      ...
      {/* Products Showcase */}
      <section className="py-16 px-4 bg-secondary/30 animate-slide-up">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Our Products</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
        {[
          { name: 'Coke', image: '/images/coke.png', desc: 'Classic Coca-Cola' },
          { name: 'Fanta', image: '/images/fanta.png', desc: 'Orange Fanta' },
          { name: 'Sprite', image: '/images/sprite.png', desc: 'Lemon-Lime Sprite' },
        ].map((product) => (
          <Card
          key={product.name}
          className="overflow-hidden hover:shadow-lg transition-transform transform hover:scale-105 hover:shadow-primary/30"
          >
          <div className="h-32">
